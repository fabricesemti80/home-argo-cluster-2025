...
REPO_URL="${REPO_URL:-https://github.com/fabricesemti80/home-argo-cluster-2025.git}"
REPO_DIR="${REPO_DIR:-/home/fs/repos/home-argo-cluster-2025}"
...
function main() {
    ...
    log info "Management VM bootstrap finished" "host=${MGMT_HOST}"
}
